...
```bash
npx skills add ninasaul/my-agent-skills --skill skillname
# or add all skills from the repo
npx skills add ninasaul/my-agent-skills
```
...
```bash
git clone git@github.com:ninasaul/my-agent-skills.git ~/temp-skills
```
